...
public class GameMenu extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        createFreeze(freeze, progressBar);
        ...
        fixedGroup = groups[1];
        gameMenuController.rotate(rotatedGroup);
        ...
        scene.setOnKeyPressed(keyEvent -> {
            ...
            if (keyName.equals("Space")) {
                if(Data.getCurrentGame().isUser1Lose()==1) {
                    ...
                    gameMenuController.shoot(fixedGroup, rotatedGroup, (Circle) fixedGroup.getChildren(). get(0));
                    ...
                    ballCount = new Label("ball count : " + numBallCount);
                    ballCount.setLayoutX(25);
                    ballCount.setLayoutY(25);
        ...
        pane.getChildren().addAll(rotatedGroup, fixedGroup);
        stage.show();
    }
